		...
		<section className="relative min-h-[90vh] lg:min-h-screen overflow-hidden bg-[#020817] text-white">
			...
			<div className="pointer-events-none hidden lg:block">
				...
				<motion.div
					...
					className="absolute right-12 top-32 glass-dark border border-cyan-500/30 rounded-xl p-4 backdrop-blur-md shadow-lg shadow-cyan-500/20"
				>
					<div className="flex items-center gap-3">
						<Globe2 className="w-5 h-5 text-cyan-400" />
						<div className="text-sm">
							<p className="text-white font-semibold">US & GCC</p>
							<p className="text-white/70 text-xs">Compliance Verified</p>
						</div>
					</div>
					<div className="mt-3 h-1 w-full rounded-full bg-gradient-to-r from-cyan-500/0 via-cyan-500/50 to-cyan-500/0 animate-shimmer" />
				</motion.div>
				...
				<motion.div
					...
					className="absolute right-40 top-72 glass-dark border border-cyan-500/30 rounded-xl p-4 backdrop-blur-md shadow-lg shadow-cyan-500/20"
				>
					<div className="flex items-center gap-3">
						<ShieldCheck className="w-5 h-5 text-cyan-400" />
						<div className="text-sm">
							<p className="text-white font-semibold">Insured & Tracked</p>
							<p className="text-white/70 text-xs">Real-time visibility</p>
						</div>
					</div>
				</motion.div>
				...
				<motion.div
					...
					className="absolute right-20 bottom-32 glass-dark border border-cyan-500/30 rounded-xl p-4 backdrop-blur-md shadow-lg shadow-cyan-500/20"
				>
					<div className="flex items-center gap-3">
						<Ship className="w-5 h-5 text-cyan-400" />
						<div className="text-sm">
							<p className="text-white font-semibold">Sea / Air Freight</p>
							<p className="text-white/70 text-xs">VIP handling</p>
						</div>
					</div>
				</motion.div>
			</div>
